...
review1 = Review.create(user_id: 1, dog_id: 1, comment: "This puppy is sooo freaking cute!")
review2 = Review.create(user_id: 2, dog_id: 2, comment: "Such a good pup. Thanks Adopt-a-paw!")
review3 = Review.create(user_id: 3, dog_id: 3, comment: "Couldn't have picked a better pup!")
review4 = Review.create(user_id: 4, dog_id: 4, comment: "We love our new addition the family.Thanks a lot adopt a paw!")
